...
from .models import tp3edgelist,ts31eventtype,ts32eventgeo
...
class ts32Form(forms.Form):
    year = forms.ChoiceField(label="Año a visualizar",choices= ts32eventgeo.objects.order_by('year').values_list("year","year").distinct());